...
#加载数据 D:\3180104584\MyGit\Github\course\ML\Assignment1
...
train_iter = DataLoader(train_dataset, shuffle = True, batch_size = 16)
test_iter = DataLoader(test_dataset, shuffle = True, batch_size = 16)
